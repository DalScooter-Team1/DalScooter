...
def lambda_handler(event, context):
    """Lambda function for API Gateway authorizer - Customer access"""
    try:
        ...
        # For customer endpoints, allow both customer and franchise groups
        if not any(group in ['customers', 'franchise'] for group in cognito_groups):
            print("User is not in an authorized group")
